...
public class TanqueListProducer {
	...
	// @Named provides access the return value via the EL variable name "Tanques"
	// in the UI (e.g.
	...
	public void onTanqueListChanged(
			@Observes(notifyObserver = Reception.IF_EXISTS) final Tanque Tanque) {
		retrieveAllTanquesOrderedByNome();
	}
