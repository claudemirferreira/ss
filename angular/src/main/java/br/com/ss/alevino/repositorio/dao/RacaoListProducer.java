...
public class RacaoListProducer {
	...
	// @Named provides access the return value via the EL variable name "Racaos"
	// in the UI (e.g.
	// Facelets or JSP view)
	@Produces
	@Named
	public List<Racao> getRacaos() {
		return racaos;
	}

	public void onRacaoListChanged(
			@Observes(notifyObserver = Reception.IF_EXISTS) final Racao Racao) {
		retrieveAllRacaosOrderedByNome();
	}
