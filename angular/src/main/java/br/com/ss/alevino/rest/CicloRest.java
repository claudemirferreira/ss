...
import br.com.ss.alevino.service.CicloService;
...
public class CicloRest {
	...
	@Consumes
	public List<Ciclo> listAllCiclos() {
		return service.findAllOrderedByPeriodo();
	}

	@GET
	@Path("/{id:[0-9][0-9]*}")
	@Produces(MediaType.APPLICATION_JSON)
	public Ciclo lookupRacaoById(@PathParam("id") long id) throws Exception {
		Ciclo ciclo = service.findById(id);
		if (ciclo == null) {
	...
	/**
	 * Creates a new racao from the values provided. Performs validation, and
	...
	/**
	 * <p>
	 * Validates the given Racao variable and throws validation exceptions based
	 ...
	 * </p>
	 * <p>
	 * If the error is caused because an existing racao with the same email is
	 * registered it throws a regular validation exception so that it can be
	 * interpreted separately.
	 * </p>
	 * 
	 * @param racao
	 *            Racao to be validated
